...
> ISBN 1번 입력 → KORMARC `.mrc` 5초 → **KOLAS III·정보누리·책이음·독서로DLS·알파스 즉시 반입**.
> **자관 PILOT 1관 (174 파일·3,383 레코드) round-trip 100% (3,383 full)** — MARC 블록별 분리표 ↓ (측정 2026-05-04·B안 Cycle 1).

[![release](https://img.shields.io/badge/release-v0.7.1-blue)]() [![tests](https://img.shields.io/badge/tests-1287%20passed-brightgreen)]() [![ruff](https://img.shields.io/badge/ruff-0%20errors-brightgreen)]() [![assertions](https://img.shields.io/badge/binary__assertions-39%2F39-brightgreen)]() [![B2C](https://img.shields.io/badge/B2C-9900%E2%82%A9%2Fmonth-brightgreen)]() [![founder-fit](https://img.shields.io/badge/founder--fit-1차_검증-blue)]() [![KWCAG](https://img.shields.io/badge/KWCAG-2.2%20Level%20AA-brightgreen)]() [![KORMARC](https://img.shields.io/badge/KORMARC-2023.12-blue)]() [![round-trip](https://img.shields.io/badge/round--trip-100%25_(PILOT_1)-brightgreen)]() [![invariants](https://img.shields.io/badge/invariants-12-brightgreen)]() [![ADRs](https://img.shields.io/badge/ADRs-0024~0051-blue)]() [![MRR_target](https://img.shields.io/badge/MRR_target-5M%E2%82%A9%2Fmonth-blue)]()
...
## ⚠️ 정직 헤더 (2026-05-20 갱신)

> **현재 상태**: 1차 베타·외부 사용자 **0명**·매출 **₩0**
>
> - ✅ 자관 PILOT 1관 검증 완료 (174 파일·3,383 레코드·round-trip 100%)
> - ⏳ 외부 사서 1cm 검증 시작 (2026-06-01 사서이마을·smalllibrary·학교도서관저널 모집)
> - ⏳ 외부 사서 5명+ 모집 (Phase 1·6~8월)
> - ⏳ 매출 1건 시도 (Phase 2·9~10월·KOLAS III EOL D-100)
> - ⏳ 매출 정점 (Phase 3·11~12월·KOLAS III EOL 2026-12-31)
>
> **핵심 원칙 (HARD RULE·CLAUDE.md)**:
> - ❌ "100% 자동" 약속 X·사서 검수 단계 항상 보존
> - ❌ raw % 신뢰도 표기 X·카테고리만 (확실/검토 필요/불확실)
> - ✅ AI 작성 사실 = KORMARC 588 + audit log + UI 명시
> - ✅ 자관 데이터 100% 로컬·SaaS 서버 저장 X (도서관 RFP 통과)
> - ✅ 알라딘 데이터 출처 표시 의무 ("도서 DB 제공 : 알라딘 인터넷서점")
> - ✅ KWCAG 2.2 Level AA·KS X 6006-0:2023.12 KORMARC·PIPA·디지털포용법 §21 정합
>
> **"안 산다" 솔직한 피드백도 환영합니다.** 1차 베타 = 완전 무료·결제 권유 X.
