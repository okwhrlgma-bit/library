...
> **출처**: D 드라이브 「○○도서관」 .xlsm **4,233개** + VBA 매크로 모두 포함
> **분석일**: 2026-04-28
...
| 사서 E 사서 자작 매크로 폴더 | 133 | 「사서 E/」 폴더 직접 |
...
### 1.2 사서 E 「상호대차_요청도서_쪽지8장_양식_18·20.xlsm」 (★ 사서 자작)

| 항목 | 값 |
|---|---|
| 크기 | 396~516KB |
| VBA 매크로 | **148~200KB** (사서 E 자작) |
| 시트 | 3건 |
...
→ **사서 E 사서 = 5년+ 매크로 자작 핵심 인력** = 우리 SaaS 베타 ICP 페르소나 1순위.
...
> "○○도서관(은평구·자관)이 5년+ 자작한 xlsm 매크로 4,233개를 분석했습니다.
>
> 우리 SaaS는 매크로 학습 X·VBA 작성 X로 동일 기능을 자동화합니다:
> - 신착도서 간지 자동 출력 (자관 자작 매크로 → 우리 SaaS Python)
> - 상호대차 요청도서 쪽지 8장 양식 자동 (사서 E 사서 자작 매크로 정합)
...
|---|---|---|
| 수서 사서 (사서 A 수서) | pdf·hwp 중심 | 표준 사용자 |
| 종합 사서 (사서 B·사서 C) | jpg·hwp·pdf 균형 | 표준 사용자 |
| **★ Excel 매크로 사서** (사서 E) | xlsm 200건+ 자작 | **1순위 ICP** (사서 시간 영역 매크로 자작) |
...
- D 드라이브: `D:\○○도서관\` xlsm 4,233개
- 자관 사서: 사서 B·사서 C·사서 A(수서·종합)·**사서 E (★ 매크로)**·사서 D·김신학·황수현
