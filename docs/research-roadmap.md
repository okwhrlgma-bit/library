...
| 영역 | 우선순위 | Claude 자동 | PO 직접 |
|---|---|---|---|
| A. 표준·매뉴얼 | ★★★ | WebFetch + 정리 | 검수 |
| B. 경쟁사 | ★★★ | WebFetch + 비교표 | 인터뷰 |
| C. 시장·통계 | ★★ | 공공 데이터 분석 | 협회 명단 |
| D. 학술 논문 | ★★ | 무료 abstract | 유료 본문 |
| E. 규제·법률 | ★★ | 법령정보·정리 | 변호사 검수 |
| F. 기술 트렌드 | ★ | 글로벌 동향 정리 | 결정 |
| G. 사용자 행태 | ★★★ | 인터뷰 가이드 | 사서 인터뷰 |
| H. 정부 지원사업 | ★★ | 사업 목록 정리 | 신청서 작성 |
