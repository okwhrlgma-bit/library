...
| 주차 | 페르소나 | 시연 자료 | KPI |
|---|---|---|---|
| 1주 | ★ Excel 매크로 사서 (사서 E) | 책단비 hwp 4 양식·상호대차 쪽지·신착 간지 자동 | Q1 결제 의향 (★ 매크로 사서 페르소나) |
| 2주 | 수서 사서 (사서 A 수서) | KOLAS F12 → 4단 검증·xlsx 도서원부 9 컬럼 | 권당 시간 절감·40 차수 routine 자동 |
...
5월 2주차 (5.8~5.14):
  ☐ 자관 PILOT 1주: ★ 매크로 사서 (사서 E) 시연
  ☐ KLA 회원 가입
  ☐ 공공데이터포털 ICP DB 다운

5월 3주차 (5.15~5.21):
  ☐ 자관 PILOT 2주: 수서 사서 (사서 A 수서) 시연
  ☐ KLA 발표 슬라이드 초안
...
- KLA 전국도서관대회 5.31 마감
- 자관 「○○도서관」 PILOT (사서 8명·5 시스템·6년 NPS·.mrc 174·35 윤동주·xlsm 4,233)
