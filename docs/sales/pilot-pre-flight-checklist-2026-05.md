...
- ☐ 5/1주 월요일 18:00 조기흠 사서 30분 시연 (1주차 시작)
...
- ☐ 자관 신착 5권 ISBN 준비 (조기흠 사서가 가장 최근 신착)
...
1주차 매크로 사서 (조기흠), 2주차 수서 (박지수), 3주차 종합 (4명),
...
또는 `docs/sales/pilot-result-templates/macro-template.json` 복사 후 채워넣기 → `logs/interviews/2026-05-XX_내를건너서_숲으로_조기흠.json`로 저장.
...
- `docs/sales/pilot-week1-action-manual.md` (조기흠 30분 시연 정밀)
