...
- [ ] **영업 자료 13건째: 학교도서관 86% 비전문가 페르소나** (1시간·L2)
  - 학교도서관 12,200관 / 사서교사 13.9% (1,660명) / 정규 사서교사 미배치 84% (공무직·기간제 포함 시 48~57% 배치)·교사 겸직
...
- [ ] **익명화 sweep — 영업 자료 11건** (1.5시간·L2)
  - `docs/sales/` 11건 grep "PILOT 자관" "PILOT자관" "은평구" "북악산" "윤동주" 등 자관 식별 키워드
...
- [x] PILOT 2주차 매뉴얼 ✅ 56e79a4 (사서 A 수서 60분)
