...
| 용어 | 정의 |
|---|---|
| **KORMARC** | 한국문헌자동화목록형식 (**KS X 6006-0:2023.12**, NLK 2차 개정). 한국 도서관 표준. **표준 8 카테고리** (BK 도서·CR 계속자료·CF 전자자료·MP 지도자료·MU 녹음자료·VM 시청각자료·RB 고서·MX 복합자료) → 우리 코드 **17 세부 subtype**으로 세분화 (book_single·serial_current·thesis·braille·rare_book 등). **3 적용 수준** M·A·O. MARC21 호환↑·시맨틱 웹·LD·외부 리소스. 150+ 필드 |
...
| **독서로DLS / KERIS DLS** | 한국 학교도서관 표준 시스템 (2024년 DLS와 통합). KERIS + 17 시·도교육청. 12,200관·사서교사 13.9% 배치·정규 사서교사 미배치 84% (공무직·기간제 포함 시 48~57% 배치) |
